...
`Apache-2.0` `PHP` `Mercurial` `Subversion`
...
`AGPL-3.0` `Python` `Mercurial` `Subversion`
...
`GPL-3.0` `Python` `Mercurial` `Subversion`
...
`Apache-2.0` `Python` `Mercurial` `Subversion`
