...
* [GitPrep](http://gitprep.yukikimoto.com/) - GitPrep is Github clone. You can install portable github system into unix/linux. You can create users and repositories without limitation. This is free software. `GPL-1.0` / [`Artistic`][2] `Perl`
...
[2]: https://dev.perl.org/licenses/artistic.html
